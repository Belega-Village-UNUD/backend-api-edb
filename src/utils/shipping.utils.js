...
const cartDetailsWithShippingCost = async (
  ...
  let shippingInfo = await Promise.all(
    transactionData.map(async (detail, iteration) => {
      ...
      console.log("==115, final.controller.js cartDetails ", cartDetails);

      return cartDetails;
    })
  );

  // console.log("==121, final.controller.js shippingInfo ", shippingInfo);
